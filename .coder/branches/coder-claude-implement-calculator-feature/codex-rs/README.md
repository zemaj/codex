...
Codex includes a built-in arithmetic calculator for quick calculations. You can use it in two ways:

**CLI mode:**
```shell
codex calc "2 + 2"
codex calc "3.14 * (2 ^ 2)"
codex calc --precision 2 "10 / 3"
codex calc --raw "1.23456789"
```

**TUI mode:**
Type `/calc` followed by an expression in the chat:
```
/calc 2 + 2
/calc (5 + 3) * 2 ^ 3
```
