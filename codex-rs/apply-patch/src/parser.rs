...
pub fn parse_patch(patch: &str) -> Result<ApplyPatchSource, ParseError> {
...
fn parse_patch_text(patch: &str, mode: ParseMode) -> Result<ApplyPatchSource, ParseError> {
    ...
    Ok(ApplyPatchSource { hunks, patch })
}
