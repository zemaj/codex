...
pub(crate) struct CommandPopup {
    ...
    all_commands: HashMap<String, SlashCommand>,
...
impl WidgetRef for CommandPopup {
    fn render_ref(&self, area: Rect, buf: &mut Buffer) {
        ...
        use ratatui::widgets::{Block, Borders, BorderType, Cell, Row, Table, Widget};
        ...
        let visible_matches: Vec<&SlashCommand> = matches.into_iter().take(MAX_POPUP_ROWS).collect();
