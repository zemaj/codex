...
mod tests {
    ...
    fn test_inherit_all() {
        ...
        policy.ignore_default_excludes = true; // keep everything
    ...
    fn test_inherit_all_with_default_excludes() {
        ...
        let mut policy = ShellEnvironmentPolicy::default();
        policy.inherit = ShellEnvironmentPolicyInherit::All; // default ignore_default_excludes = false
    ...
    fn test_inherit_none() {
        ...
        let mut policy = ShellEnvironmentPolicy::default();
        policy.inherit = ShellEnvironmentPolicyInherit::None;
        policy.ignore_default_excludes = true;
        policy
            .r#set
