...
impl SandboxPolicy {
    ...
    pub fn new_read_only_policy_with_writable_roots(writable_roots: Vec<PathBuf>) -> Self {
    ...
    pub fn new_full_auto_policy_with_writable_roots(writable_roots: Vec<PathBuf>) -> Self {
