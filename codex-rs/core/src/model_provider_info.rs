...
impl ModelProviderInfo {
    ...
    pub fn api_key(&self) -> crate::error::Result<Option<String>> {
        match &self.env_key {
            Some(env_key) => std::env::var(env_key).map(Some).map_err(|_| {
    ...
    [
        (
            ...
            P {
                ...
                env_key_instructions: Some("Create an API key (https://platform.openai.com) and export as an environment variable".into()),
