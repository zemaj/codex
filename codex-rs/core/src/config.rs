...
impl Config {
    ...
    /// be used in all other cases. Note TempDir is required to ensure tests
    /// create a unique config directory for each test run so they do not
    /// interfere with each other.
    pub fn load_default_config_for_test(codex_home: &TempDir) -> Self {
