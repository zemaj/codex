...
Currently, `vscode` is the default, though Codex does not though verify VS Code is installed. As such, `file_opener` may default to `none` or something else in the future.
