...
use crate::codex_tool_config::CodexToolCallParam as CodexToolConfig;
use tokio::sync::mpsc;
...
impl MessageProcessor {
    ...
    fn handle_call_tool(
        ...
        let config: CodexConfig = match arguments {
            Some(json_val) => match serde_json::from_value::<CodexToolConfig>(json_val) {
        ...
        task::spawn(async move {
            ...
            crate::codex_tool_runner::run_codex_tool_session(id, config, outgoing).await;
        });
    }
