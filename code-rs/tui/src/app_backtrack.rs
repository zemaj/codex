...
use code_core::protocol::ConversationHistoryResponseEvent;
...
impl App {
    ...
    pub(crate) fn request_backtrack(
        ...
        self.app_event_tx.send(crate::app_event::AppEvent::CodexOp(
            code_core::protocol::Op::GetHistory,
        ));
    }
    ...
    async fn perform_fork(
        &self,
        entries: Vec<code_protocol::models::ResponseItem>,
        drop_count: usize,
        cfg: code_core::config::Config,
    ) -> code_core::error::Result<code_core::NewConversation> {
        self.server
    ...
    fn install_forked_conversation(
        ...
        tui: &mut tui::Tui,
        cfg: code_core::config::Config,
        new_conv: code_core::NewConversation,
        drop_count: usize,
        prefill: &str,
    ) {
